...
class SelfsupLocHead_Double1X1(nn.Module):
    """
    ...
    def __init__(self,
                 ...
                 with_last_bn=True,
                 with_last_norm=True):
        super(SelfsupLocHead_Double1X1, self).__init__()
        self.in_channels = in_channels
        self.hid_channels = hid_channels
        self.out_channels = out_channels
        self.weight_loss = weight_loss
        self.conv1_0 = ConvModule(256, 2048, 1, norm_cfg=dict(type='BN'))
        self.conv2_0 = ConvModule(256, 2048, 1, norm_cfg=dict(type='BN'))
        if avg_max == 'avg':
    ...
    def forward(self, t_org_feat, t_aug_feat, s_org_feat,s_aug_feat, gt):
        ...
        s_org_feat = self.conv2_0(s_org_feat)
        t_aug_feat = self.conv1_0(t_aug_feat)
        s_aug_feat = self.conv2_0(s_aug_feat)
