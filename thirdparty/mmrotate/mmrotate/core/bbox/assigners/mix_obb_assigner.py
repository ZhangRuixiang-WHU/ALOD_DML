...
class MixObbAssigner(BaseAssigner):
    ...
    def assign(self, bboxes, gt_bboxes, gt_bboxes_redundancy, gt_bboxes_ignore=None, gt_labels=None, ast_bboxes=None):
        ...
        if gt_bboxes_redundancy is not None:
            ...
            overlaps_pos = self.iou_calculator_pos(gt_bboxes,  bboxes)
            ...
            assign_result = self.assign_wrt_overlaps(overlaps_pos, gt_labels)
            ...
            for i in range(num_gts):
                if gt_max_overlaps[i] >= self.min_pos_iou:
                    if self.gt_max_assign_all:
                        max_iou_inds = overlaps_pos[i, :] == gt_max_overlaps[i]
