...
class AITODReval:
    ...
    #  aitodrGt=..., aitodrDt=...       # load dataset and results
    #  E = CocoEval(aitodrGt,aitodrDt); # initialize CocoEval object
    ...
    def __init__(self, annotations=None, results=None, numCats=18, iouType='mAP', nproc=10):
        '''
        Initialize CocoEval using coco APIs for gt and dt
        :param aitodrGt: coco object with ground truth annotations
        :param aitodrDt: coco object with detection results
        :return: None
        '''
        if not iouType:
        ...
        self.params = AITODRParams(iouType=iouType)  # parameters
...
class AITODRParams:
    ...
    def setDetParams(self):
        ...
        self.maxDets = [1500]
        self.areaRng = [[0 ** 2, 1e5 ** 2], [2 ** 2, 8 ** 2], [8 ** 2, 16 ** 2],
                [16 ** 2, 32 ** 2], [32 ** 2, 64 ** 2]]
        self.areaRngLbl = ['all', 'very tiny', 'tiny', 'small', 'medium']
        self.useCats = 1
